...
labyrinth = media.Movie("Labyrinth",
                        ...
                        "Jim Henson was a genius and David Bowie has something\
                         crazy going on with his pants.")

dark_crystal = media.Movie("The Dark Crystal",
                           "Mutant turkeys try to stop a boy from fixing\
                           their magic stone.",
                           "https://upload.wikimedia.org/wikipedia/en/7/77/\
                           The_Dark_Crystal_Film_Poster.jpg",
                           "https://www.youtube.com/watch?v=wW23YcaBHUg",
                           "It's weird, dark, and another Jim Henson\
                            masterpiece")

dredd = media.Movie("Dredd",
                    "Judge, jury, and executioner - he brings to law to a\
                    giant apartment complex.",
                    "https://upload.wikimedia.org/wikipedia/en/1/16/\
                    Dredd2012Poster.jpg",
                    "https://www.youtube.com/watch?v=G-eI5oLlIeY",
                    "Intense action set in a dystopia future. Karl\
                     Urban's best role.")

willy_wonka_chocolate_factory = media.Movie("Willy Wonka and the Chocolate\
                                             Factory",
                                            "Like Saw but with a chocolate\
                                             factory and children.",
                                            "https://upload.wikimedia.org/\
                                            wikipedia/en/7/7f/WillyWonkaMovie\
                                            Poster.jpg",
                                            "https://www.youtube.com/\
                                            watch?v=GNarV_3P4oM",
                                            "Whimsical and imaginative. Roald\
                                             Dahl not approved, though.")

star_wars = media.Movie("Star Wars",
                        "A boy kisses his sister then goes off to kill\
                         his dad with his gang of robots",
...
life_aquatic = media.Movie("The Life Aquatic with Steve Zissou",
                           "Bill Murry hunts down a shark with his kind-of-son\
                            and a pretty cool pregnant lady. Pirates.",
...
crouching_tiger = media.Movie("Crouching Tiger, Hidden Dragon",
                              ...
                              "https://upload.wikimedia.org/wikipedia/en/9/97/\
                              Crouching_tiger_hidden_dragon_poster.jpg",
                              "https://www.youtube.com/watch?v=oEaGsdiA0y0",
                              "Beautiful music, lush environments,\
                               fun action.")
...
walle = media.Movie("Wall-e",
                    ...
                    "A feel good movie worth watching over and over. Weirdly \
                    works with Pink Floyd's Dark Side of the Moon too.")

nightmare_before_christmas = media.Movie("Nightmare Before Christmas",
                                         "Making Christmas, making Christmas.\
                                          Just kidding, it's Halloween.",
                                         "https://upload.wikimedia.org/\
                                         wikipedia/en/9/9a/The_nightmare_\
                                         before_christmas_poster.jpg",
                                         "https://www.youtube.com/\
                                         watch?v=8qrB9I3DM80",
                                         "Tim Burton's best.")

movies = [labyrinth, dark_crystal, dredd, willy_wonka_chocolate_factory,
          star_wars, life_aquatic, crouching_tiger, walle,
